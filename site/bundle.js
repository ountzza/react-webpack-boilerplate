...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2),  
	    Checkout = __webpack_require__(3);
	...
	var App = React.createClass({displayName: 'App',
	  ...
	  render: function() {
	    var listItems = this.props.items.map(function(item, i) {
	      return React.createElement("li", {key: "item" + i, onClick: this.onSelectItem.bind(null, i)}, item.title)
	    }.bind(this));
	    ...
	    return (
	      React.createElement("div", null, 
	        ...
	        React.createElement(Checkout, {items: this.state.selectedItems})
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Checkout = React.createClass({displayName: 'Checkout',
	  ...
	  render: function() {
	    var listItems = this.props.items.map(function(item, i) {
	      return React.createElement("li", {key: "selectedItem" + i}, item.title)
	    });
